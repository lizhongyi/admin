   ...
   <div class="block" id="block-tables">
          <div class="secondary-navigation">
            <ul class="wat-cf">
              ...
              <li><a href="/User/company">联系方式</a></li>
          ...
          <div class="content">
           ...
           <form action="/About/do_modfy/id/<?php echo ($dt['id']); ?>" method="post" class="form">
                ...
                <div class="group">
                  ...
                  <textarea id="editor_id" name="content" class="text_area" rows="50" cols="80" style="height:600px; overflow:auto"><?php echo ($dt['content']); ?></textarea>
