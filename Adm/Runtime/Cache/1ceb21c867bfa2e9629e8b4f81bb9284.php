   ...
   <div class="block" id="block-tables">
          <div class="secondary-navigation">
            <ul class="wat-cf">
              ...
              <li><a href="/User/company">企业列表</a></li>
              ...
              <form action="#" class="form">
                <table class="table">
                  <tbody><tr>
                    ...
                    <th width="72">序号</th>
                    <th width="232">企业名称</th>
                    <th width="139">所在地区</th>
                    <th width="238">创建时间</th>
                    <th width="99" class="last">操作</th>
                  </tr>
                   ...
                   <?php if(is_array($getList)): $i = 0; $__LIST__ = $getList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                    <td><input type="checkbox" class="checkbox" name="id" value="1"></td><td><?php echo ($key+1); ?></td>
                    <td><?php echo ($vo['companyname']); ?></td>
                    <td><?php echo ($vo['area_cn']); ?></td>
                    <td><?php echo (date('Y-m-d',$vo['create_time'])); ?></td>
                    <td class="last"> <a href="/Client/detail/id/<?php echo ($vo["id"]); ?>">查看</a> </td>
