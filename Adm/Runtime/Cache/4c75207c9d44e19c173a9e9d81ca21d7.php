  ...
  <div id="main">
   <div class="block" id="block-tables">
          <div class="secondary-navigation">
            <ul class="wat-cf">
              <li class="first active"><a href="/User">全部用户</a></li>
              <li><a href="/User/company">企业账户</a></li>
              ...
              <form action="#" class="form">
                <table class="table">
                  <tbody><tr>
                    ...
                    <th width="114">用户类型</th>
                    <th width="179">用户状态</th>
                    <th width="273">最后登录时间</th>
                    <th width="149">注册时间</th>
                   ...
                   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                    <td><input type="checkbox" class="checkbox" name="id" value="1"></td><td><?php echo ($vo['uid']); ?></td><td><?php echo ($vo['username']); ?></td><td><?php echo ($vo['email']); ?></td>
                    <td><?php if($vo['pid'] == 0): ?>公司用户<?php else: ?> 子用户<?php endif; ?></td>
                    <td> <?php if($vo["step"] < 2): ?><span style="color:#F00">未激活</span>
                  <?php else: ?>
                  <span style="color: #009900">已激活</span><?php endif; ?></td>
                    <td>
        ...
        <?php echo (date("Y-m-d",$vo["last_login_time"])); endif; ?>
                    ...
                    <td class="last"> <a href="/User/detail/uid/<?php echo ($vo["uid"]); ?>">查看</a> |  <a href="/User/delete/uid/<?php echo ($vo['uid']); ?>">删除</a></td>
