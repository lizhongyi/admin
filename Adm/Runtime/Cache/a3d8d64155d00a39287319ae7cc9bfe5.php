  ...
  <div id="main">
   <div class="block" id="block-tables">
          <div class="secondary-navigation">
            <ul class="wat-cf">
              <li class="first"><a href="/User">全部用户</a></li>
              <li  class="active"><a href="/User/company">企业账户</a></li>
                ...
                <table class="table">
                  <tbody><tr>
                   ...
                   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                    ...
                    <td class="last"><a href="/User/profile_company/uid/<?php echo ($vo['uid']); ?>">查看</a>  | <a href="#">删除</a></td>
