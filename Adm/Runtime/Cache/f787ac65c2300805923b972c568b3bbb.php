  ...
  <div id="main">
   <div class="block" id="block-tables">
          <div class="secondary-navigation">
            <ul class="wat-cf">
              <li class="first active"><a href="/User">候选人列表</a></li>
              <li><a href="/User/company">候选人详情</a></li>
                ...
                <table class="table">
                  <tbody><tr>
                   ...
                   <?php if(is_array($getList)): $i = 0; $__LIST__ = $getList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                    ...
                    <td><?php echo ($vo['id']); ?></td><td><?php echo ($vo['realname']); ?></td>
                    <td><?php echo (get_gid($vo['gid'])); ?></td>
                    <td><?php echo (get_com($vo['comid'])); ?></td>
